...
images = "C:/Users/Legion Y540/Desktop/deepLearning Mcchran/dataset/input_mixed_ultr_oxy"
masks = "C:/Users/Legion Y540/Desktop/deepLearning Mcchran/dataset/output_mixed_ultr_oxy"

if __name__=="__main__":
    print ("[INFO] testing the augmentation process")
    image_paths = glob(os.path.join(images, "*.bmp"))
    mask_paths =  glob(os.path.join(masks, "*.bmp")) #list(map(lambda image_path: os.path.join(masks, image_path.split("/")[-1].split(".")[0]+"_mask.bmp"), image_paths ))
